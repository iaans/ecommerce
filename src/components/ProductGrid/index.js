      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        <div>
          ...
          <div class="flex justify-between items-start bg-gray-100 rounded-b-lg gap-2 p-4">
            ...
            <div class="flex flex-col items-end">
              <span class="text-gray-600 lg:text-lg font-bold">R$250,97</span>
              <span class="text-red-500 text-sm line-through">R$500,97</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="flex justify-between items-start bg-gray-100 rounded-b-lg gap-2 p-4">
            ...
            <div class="flex flex-col items-end">
              <span class="text-gray-600 lg:text-lg font-bold">R$207,58</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="flex justify-between items-start bg-gray-100 rounded-b-lg gap-2 p-4">
            ...
            <div class="flex flex-col items-end">
              <span class="text-gray-600 lg:text-lg font-bold">R$310.00</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="flex justify-between items-start bg-gray-100 rounded-b-lg gap-2 p-4">
            ...
            <div class="flex flex-col items-end">
              <span class="text-gray-600 lg:text-lg font-bold">R$276,24</span>
            </div>
          </div>
        </div>
      </div>
