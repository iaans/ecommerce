      ...
      <div className="max-w-screen-xl px-4 md:px-8 mx-auto">
        ...
        <div className="mb-10 md:mb-16">
          ...
          <p className="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">
            A RV marcas é composta por profissionais espalhados por todo país.
            Esses profissionais por sua vez, tem vontade imensa de empreender
            com vestuário. Surgiu então a oportunidade de criar a RV marcas. A
            RV marcas é especializada em vestuário modernista.
          </p>
        </div>
        {/* <!-- text - end --> */}
